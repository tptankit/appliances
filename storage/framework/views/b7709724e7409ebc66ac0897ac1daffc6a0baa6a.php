        ...
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <div class="payment-methods ">
                    <ul>
                        <li><img alt="" src="<?php echo url(''); ?>/assets/images/payments/payment-visa.png"></li>
                        <li><img alt="" src="<?php echo url(''); ?>/assets/images/payments/payment-master.png"></li>
                        <li><img alt="" src="<?php echo url(''); ?>/assets/images/payments/payment-paypal.png"></li>
                        <li><img alt="" src="<?php echo url(''); ?>/assets/images/payments/payment-skrill.png"></li>
                    </ul>
                </div><!-- /.payment-methods -->
            </div>
        </div><!-- /.container -->
...
<script src="<?php echo url(''); ?>/assets/js/jquery-1.10.2.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/jquery-migrate-1.2.1.js"></script>
<script src="<?php echo url(''); ?>/assets/js/bootstrap.min.js"></script>
<script src="http://maps.google.com/maps/api/js?sensor=false&amp;language=en"></script>
<script src="<?php echo url(''); ?>/assets/js/gmap3.min.js"></script>
...
<script src="<?php echo url(''); ?>/assets/js/css_browser_selector.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/echo.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/jquery.easing-1.3.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/bootstrap-slider.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/jquery.raty.min.js"></script>
<script src="<?php echo url(''); ?>/assets/js/jquery.prettyPhoto.min.js"></script>
...
<script src="<?php echo url(''); ?>/switchstylesheet/switchstylesheet.js"></script>
