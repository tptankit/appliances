...
<div class="wrapper">
            ...
            <div class="col-xs-12 col-sm-6 no-margin">
                <ul class="right">
                    ...
                    if (Auth::user()) {
                        ...
                        <li><a href="<?= url('') ?>/friend_wishlist">Friend's Wishlist</a></li>
                        <?php
                    } else {
                        ?>
                ...
                <div class="top-cart-row-container">
                    <div class="wishlist-compare-holder">
                        <div class="wishlist ">
                            ...
                            <?php } else {
                                ?>
                                <a href="<?= url('') ?>/addtowishlistmsg"><i class="fa fa-heart"></i> wishlist  </a>
                            <?php }
                            ?>
                        ...
                        <div class="basket">
                            ...
                            <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                                ...
                                <div class="total-price-basket"> 
                                    <a href="<?= url('') ?>/cart" class="le-button inverse">View cart</a>
                                </div>
                            </a>
                        ...
                        <ul class="nav navbar-nav">
                            ...
                            if (!empty($categories)) {
                                foreach ($categories as $category) {
                                    ?>
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><?= $category['category_name'] ?></a>
                                                        ...
                                                        if (!empty($category['child'])) {
                                                            foreach ($category['child'] as $child) {
                                                                ...
                                                                <div class="col-xs-12 col-sm-4">
                                                                    <h2><a href="<?= url('') ?>/category-id/<?= $child['category_id'] ?>"><?= $child['category_name'] ?></a></h2>
                                                                    <?php
                                                                    if (!empty($child['child'])) {
                                                                        ?>
                                                                        <ul>
                                                                            <?php foreach ($child['child'] as $s_child) {
                                                                                ?>
                                                                                <li><a href="<?= url('') ?>/category-id/<?= $s_child['category_id'] ?>"><?= $s_child['category_name'] ?></a></li>
                                                                            <?php } ?>
                                                                        </ul>
                                                                        <?php
                                                                    }
                                                            ...
                                                            ?>
                                                            <div class="col-xs-12 col-sm-4">
                                                                <h2><a href="<?= url('') ?>/category-id/<?= $category['category_id'] ?>"><?= $category['category_name'] ?></a></h2>
    ...
    <div class="message-all">
        <section class="message-box_admin">
